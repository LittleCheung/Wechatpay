...
import paymentdemo.enums.wxpay.WxApiType;
import paymentdemo.enums.wxpay.WxNotifyType;
import paymentdemo.enums.wxpay.WxRefundStatus;
import paymentdemo.enums.wxpay.WxTradeState;
...
import paymentdemo.util.HttpClientUtils;
...
public class WxPayServiceImpl implements WxPayService {
    ...
    public Map<String, Object> nativePay(Long productId) throws Exception {
        ...
        try {
            ...
            } else if (statusCode == 204) { //处理成功，无返回结果
                log.info("成功");
            } else {
     ...
     * 如果订单已支付，则更新商户端订单状态，并记录支付日志；如果订单未支付，则调用关单接口关闭订单，并更新商户端订单状态
     * @param orderNo
     */
    @Transactional(rollbackFor = Exception.class)
    @Override
